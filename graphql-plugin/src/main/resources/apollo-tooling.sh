...
# The idea of bundling apollo cli and this script is taken from official apollo-ios repository.
# The original version can be found at https://github.com/apollographql/apollo-ios/blob/master/scripts/run-bundled-codegen.sh
