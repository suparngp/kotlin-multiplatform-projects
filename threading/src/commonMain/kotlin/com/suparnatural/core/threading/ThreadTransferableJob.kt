 ...
 * ```
 */
class ThreadTransferableJob<Input, Output>
private constructor(
        /**
    ...
    companion object {
        ...
        /**
         * Create a new [ThreadTransferableJob]
         */
        fun <I, O> create(payload: I, job: (O) -> Unit): ThreadTransferableJob<I, O> {
            return toImmutable(ThreadTransferableJob(payload, job))
        }
    }
}
