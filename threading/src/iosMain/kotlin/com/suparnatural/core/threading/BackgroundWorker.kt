...
class BackgroundWorker(private val worker: Worker = Worker.start()) : com.suparnatural.core.threading.Worker {
    ...
    override fun <T, V, W> executeAndResume(
            jobInput: T,
            job: (T) -> V,
            resumingWorker: com.suparnatural.core.threading.Worker,
