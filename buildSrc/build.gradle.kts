...
plugins {
    ...
    id("org.jetbrains.kotlin.native.cocoapods").version("1.3.61").apply(false)
...
dependencies {
    ...
    implementation(group = "org.jetbrains.kotlin", name = "kotlin-gradle-plugin", version = "1.3.61")
    ...
    implementation(group = "org.jetbrains.kotlin", name = "kotlin-serialization", version = "1.3.61")
}
