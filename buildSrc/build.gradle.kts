...
plugins {
    ...
    id("kotlin-multiplatform").version("1.3.60").apply(false)
    id("org.jetbrains.kotlin.native.cocoapods").version("1.3.60").apply(false)
...
dependencies {
    ...
    implementation(group = "org.jetbrains.kotlin", name = "kotlin-gradle-plugin", version = "1.3.60")
    ...
    implementation(group = "org.jetbrains.kotlin", name = "kotlin-serialization", version = "1.3.60")
}
